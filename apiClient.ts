...
import { ApiResponse, LoginCredentials, AuthUser, Employee, Category, Device } from './types';
...
class ApiClient {
  ...
  async updateEmployee(id: string, employee: Omit<Employee, 'id'>): Promise<ApiResponse<Employee>> {
  ...
  async updateCategory(id: string, category: Omit<Category, 'id'>): Promise<ApiResponse<Category>> {
  ...
  async updateDevice(id: string, device: Omit<Device, 'id'>): Promise<ApiResponse<Device>> {
